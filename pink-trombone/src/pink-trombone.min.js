...
class TractUI {
  ...
  _drawTract() {
    ...
    this._context.strokeStyle = this._context.fillStyle = "#1d3454";
    this._moveTo(1, 0);
  ...
  //  this._drawText(this._processor.tract.length * 0.1, 0.425, "koro", false, false);
  //  this._drawText(this._processor.tract.length * 0.71, -1.8, "isung", false, false);
  //  this._drawText(this._processor.tract.length * 0.71, -1.3, "k", false, false);

 //   this._context.font = "22px Arial";
 //   this._drawText(this._processor.tract.length * 0.6, 0.9, "ngutu", false, false);
 //   this._drawText(this._processor.tract.length * 0.7, 0.9, "cavity", false, false);
    ...
    this._context.strokeStyle = "#071c37";
 ...
 //   this._drawText(
  ...
  //  );
    ...
    this._context.globalAlpha = 1;
    this._context.fillStyle = "#071c37";
  ...
  _drawTongueControl() {
    this._context.lineCap = this._context.lineJoin = "round";
    this._context.strokeStyle = this._context.fillStyle = "#061b36"; // palePink
    ...
    this._context.fillStyle = "#1d3454";
    this._context.globalAlpha = 1.0;
  ...
  _drawPositions() {
   ...
   //   [130, 0.27, "a"], // part
   //   [120, 0, "ɒ"], // pot
   //   [170.7, 0.05, "(ɔ)"], // port (rounded)
   //   [270, 0.65, "ɪ"], // pit
   //   [207.4, 0.21, "i"], // peat
   //   [200, 1.0, "e"], // pet
   //   [180.1, 0.37, "ʌ"], // putt
   //   [230, 0.1, "(u)"], // poot (rounded)
  //    [210, 0.6, "ə"], // pert [should be ɜ]
    ].forEach((position) => {
...
class GlottisUI {
  constructor() {
    ...
    this._container.style.backgroundColor = "#1d3454";
...
class ButtonsUI {
  ...
  _createButton(buttonName, isParameter = false, parameterPath) {
    ...
    button.style.backgroundColor = "#1c3453";
    button.style.border = "#061b36";
